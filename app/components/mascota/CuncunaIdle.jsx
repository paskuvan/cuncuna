// ============================================================
// Cuncuna Idle - estado base, expresión feliz neutra
// ============================================================

export default function CuncunaIdle({ size = 80, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Sonrisa */}
      <path d="M 36 65 Q 50 72 64 65" stroke="#000" strokeWidth="3" fill="none" strokeLinecap="round" />
